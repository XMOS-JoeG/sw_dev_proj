...
#else
{int, int, int} spdif_rx(streaming chanend c, in port p_spdif, clock clk, unsigned sample_freq_estimate);
#endif */
...
void spdif_receive_sample(streaming chanend c, int32_t &sample, size_t &index, size_t &block_start);
